...
log_model_learning_control <- glmer(correct ~ condition + (1 | ID), data = logreg_learning_correct_condition_df, family = "binomial")
...
log_model_learning_goalstate <- glmer(correct ~ condition + (1 | ID), data = logreg_learning_correct_condition_df, family = "binomial")
...
log_model_learning_reward <- glmer(correct ~ condition + (1 | ID), data = logreg_learning_correct_condition_df, family = "binomial")
...
log_model_learning_transition <- glmer(correct ~ condition + (1 | ID), data = logreg_learning_correct_condition_df, family = "binomial")
...
log_model_control <- glmer(switch ~ condition + (1 | ID), data = logreg_test_switch_condition_df, family = "binomial")
...
log_model_goalstate <- glmer(switch ~ condition + (1 | ID), data = logreg_test_switch_condition_df, family = "binomial")
...
log_model_reward <- glmer(switch ~ condition + (1 | ID), data = logreg_test_switch_condition_df, family = "binomial")
...
log_model_transition <- glmer(switch ~ condition + (1 | ID), data = logreg_test_switch_condition_df, family = "binomial")
