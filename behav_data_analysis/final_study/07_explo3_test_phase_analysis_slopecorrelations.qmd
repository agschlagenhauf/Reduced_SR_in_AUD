...
```{r}
# sr correlations
r.values <- rcorr(as.matrix(cbind(individual_mb_slopes, individual_mf_slopes, individual_redsr_slopes, individual_sr_slopes)), type="spearman")$r[1:3,"individual_sr_slopes"]
r.values
p.values <- rcorr(as.matrix(cbind(individual_mb_slopes, individual_mf_slopes, individual_redsr_slopes, individual_sr_slopes)), type="spearman")$P[1:3,"individual_sr_slopes"]
p.adjust(p.values, method = "BH", n = length(p.values))
