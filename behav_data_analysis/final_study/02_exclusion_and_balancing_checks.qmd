...
payment_df[payment_df$version=="Alcohol version" & 
             ...
             payment_df$mean_correct==max(payment_df$mean_correct[payment_df$version=="Alcohol version" & payment_df$group=="Low-risk drinkers"]),]

payment_df[payment_df$version=="Alcohol version" & 
             payment_df$group=="Harmful drinkers" &
             payment_df$mean_correct==max(payment_df$mean_correct[payment_df$version=="Alcohol version" & payment_df$group=="Harmful drinkers"]),]

payment_df[payment_df$version=="Monetary version" & 
             payment_df$group=="Low-risk drinkers" &
             payment_df$mean_correct==max(payment_df$mean_correct[payment_df$version=="Monetary version" & payment_df$group=="Low-risk drinkers"]),]

payment_df[payment_df$version=="Monetary version" & 
             payment_df$group=="Harmful drinkers" &
             payment_df$mean_correct==max(payment_df$mean_correct[payment_df$version=="Monetary version" & payment_df$group=="Harmful drinkers"]),]
