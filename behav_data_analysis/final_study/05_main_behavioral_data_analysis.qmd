...
```{r}
ggplot(balancing_variations_df, aes(x=variation, fill=variation)) +
  geom_bar() +
  theme_light(base_size = 16) +
  theme(legend.position = "none") +
...
log_model_learning_paths_control <- glmer(correct_path ~ group*version*condition + (1 + condition | ID), data = logreg_learning_correct_paths_group_version_condition_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) 
...
log_model_learning_paths_goalstate <- glmer(correct_path ~ group*version*condition + (1 + condition | ID), data = logreg_learning_correct_paths_group_version_condition_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_policy <- glmer(correct_path ~ group*version*condition + (1 + condition | ID), data = logreg_learning_correct_paths_group_version_condition_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_reward <- glmer(correct_path ~ group*version*condition + (1 + condition | ID), data = logreg_learning_correct_paths_group_version_condition_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_transition <- glmer(correct_path ~ group*version*condition + (1 + condition | ID), data = logreg_learning_correct_paths_group_version_condition_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_env_control <- glmer(correct_path ~ group*version*condition + (1 + condition | ID) + (1 + group*version*condition | environment), data = logreg_learning_correct_paths_group_version_condition_env_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) 
...
log_model_learning_paths_env_goalstate <- glmer(correct_path ~ group*version*condition + (1 + condition | ID) + (1 + group*version*condition | environment), data = logreg_learning_correct_paths_group_version_condition_env_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_env_policy <- glmer(correct_path ~ group*version*condition + (1 + condition | ID) + (1 + group*version*condition | environment), data = logreg_learning_correct_paths_group_version_condition_env_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_env_reward <- glmer(correct_path ~ group*version*condition + (1 + condition | ID) + (1 + group*version*condition | environment), data = logreg_learning_correct_paths_group_version_condition_env_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_env_transition <- glmer(correct_path ~ group*version*condition + (1 + condition | ID) + (1 + group*version*condition | environment), data = logreg_learning_correct_paths_group_version_condition_env_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_time_control <- glmer(correct_path ~ group*version*condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + group*version*condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_learning_paths_group_version_condition_env_time_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_time_goalstate <- glmer(correct_path ~ group*version*condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + group*version*condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_learning_paths_group_version_condition_env_time_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_time_policy <- glmer(correct_path ~ group*version*condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + group*version*condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_learning_paths_group_version_condition_env_time_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_time_reward <- glmer(correct_path ~ group*version*condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + group*version*condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_learning_paths_group_version_condition_env_time_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
log_model_learning_paths_time_transition <- glmer(correct_path ~ group*version*condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + group*version*condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_learning_paths_group_version_condition_condition_index_df, family = "binomial", control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model1 <- glmer(correct_path ~ condition + (1 | ID), data = logreg_test_path_condition_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model2 <- glmer(correct_path ~ condition + (1 | ID), data = logreg_test_path_condition_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model4 <- glmer(correct_path ~ condition*group + (1 | ID), data = logreg_test_path_group_condition_df_alcohol, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model1_control <- glmer(correct_path ~ condition + (1 | ID), data = logreg_test_path_condition_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model4_control <- glmer(correct_path ~ condition*group + (1 | ID), data = logreg_test_path_group_condition_df_alcohol, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model1_full <- glmer(correct_path ~ condition + (1 + condition | ID), data = logreg_test_path_condition_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model2_full <- glmer(correct_path ~ condition + (1 + condition | ID), data = logreg_test_path_condition_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model4_full <- glmer(correct_path ~ condition*group + (1 + condition | ID), data = logreg_test_path_group_condition_df_alcohol, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model1_full_control <- glmer(correct_path ~ condition + (1 + condition | ID), data = logreg_test_path_condition_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model4_full_control <- glmer(correct_path ~ condition*group + (1 + condition | ID), data = logreg_test_path_group_condition_df_alcohol, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model1_env <- glmer(correct_path ~ condition + (1 + condition | ID) + (1 + condition | environment), data = logreg_test_path_condition_env_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model2_env <- glmer(correct_path ~ condition + (1 + condition | ID) + (1 + condition | environment), data = logreg_test_path_condition_env_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model4_env <- glmer(correct_path ~ condition*group + (1 + condition | ID) + (1 + group*version*condition | environment), data = logreg_test_path_group_condition_env_df_alcohol, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model1_env_control <- glmer(correct_path ~ condition + (1 + condition | ID) + (1 + condition | environment), data = logreg_test_path_condition_env_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model4_env_control <- glmer(correct_path ~ condition*group + (1 + condition | ID) + (1 + group*condition | environment), data = logreg_test_path_group_condition_env_df_alcohol, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model1_time <- glmer(correct_path ~ condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_test_path_condition_env_time_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
...
model2_time <- glmer(correct_path ~ condition*(condition_index+accumulated_state1_visits) + (1 + condition*(condition_index+accumulated_state1_visits) | ID) + (1 + condition*(condition_index+accumulated_state1_visits) | environment), data = logreg_test_path_condition_env_time_df_lowrisk_control, family = "binomial", glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e5)))
