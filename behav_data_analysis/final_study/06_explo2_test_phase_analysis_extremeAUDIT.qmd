...
```{r}
audit_quantile_25 <- quantile(demo_psych$audit_sum_pre, 0.25)
audit_quantile_75 <- quantile(demo_psych$audit_sum_pre, 0.75)

demo_psych <- demo_psych %>%
  filter(audit_sum_pre < audit_quantile_25 | audit_sum_pre > audit_quantile_75)
