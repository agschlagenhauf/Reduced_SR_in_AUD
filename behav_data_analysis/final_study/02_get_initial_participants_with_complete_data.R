...
prolific_alc_lowrisk_1 <- prolific_alc_lowrisk_1 %>%
  ...
  select(Participant.id, Ethnicity.simplified, Country.of.birth, Country.of.residence, Nationality, Language,
...
prolific_alc_lowrisk <- rbind(prolific_alc_lowrisk_1, prolific_alc_lowrisk_2, prolific_alc_lowrisk_3, prolific_alc_lowrisk_4, prolific_alc_lowrisk_5)
...
prolific_alc_harmful <- rbind(prolific_alc_harmful_1, prolific_alc_harmful_2, prolific_alc_harmful_3, prolific_alc_harmful_4)
...
prolific_con_lowrisk <- rbind(prolific_con_lowrisk_1, prolific_con_lowrisk_2, prolific_con_lowrisk_3, prolific_con_lowrisk_4, prolific_con_lowrisk_5)
...
prolific_con_harmful <- rbind(prolific_con_harmful_1, prolific_con_harmful_2, prolific_con_harmful_3, prolific_con_harmful_4, prolific_con_harmful_5, prolific_con_harmful_6)
...
# exclude participant who was approved, but did not fill in post questionnaires
prolific_con_harmful <- prolific_con_harmful %>%
