...
log_model_learning_paths_sum <- glmer(correct_path ~ group*version*condition + (1 | ID),
                                          data = logreg_learning_correct_paths_group_version_condition_df,
                                          family = "binomial",
                                          control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
saveRDS(log_model_learning_paths_sum, file=file.path(model_path, "log_model_learning_paths_sum.rds"))
log_model_learning_paths_sum <- readRDS(file.path(model_path, "log_model_learning_paths_sum.rds"))

log_model_learning_paths_sum_rs <- glmer(correct_path ~ group*version*condition + (1 + condition | ID),
                                          data = logreg_learning_correct_paths_group_version_condition_df,
                                          family = "binomial",
                                          control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
saveRDS(log_model_learning_paths_sum_rs, file=file.path(model_path, "log_model_learning_paths_sum_rs.rds"))
log_model_learning_paths_sum_rs <- readRDS(file.path(model_path, "log_model_learning_paths_sum_rs.rds"))

anova(log_model_learning_paths_sum, log_model_learning_paths_sum_rs)

tab_model(log_model_learning_paths_sum_rs, show.est = T, show.stat = T, auto.label = FALSE, CSS = list(css.table = '+font-size: 14;'))
```
...
### LogReg1: Difference from control condition in last 5 trials of learning phase
...
log_model_learning_paths_control <- glmer(correct_path ~ group*version*condition + (1 | ID),
                                          ...
                                          family = "binomial",
                                          control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
saveRDS(log_model_learning_paths_control, file=file.path(model_path, "log_model_learning_paths_control_last5.rds"))
log_model_learning_paths_control <- readRDS(file.path(model_path, "log_model_learning_paths_control_last5.rds"))
...
log_model_learning_paths_control_rs <- glmer(correct_path ~ group*version*condition + (1 + condition | ID),
                                          ...
                                          family = "binomial",
                                          control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
saveRDS(log_model_learning_paths_control_rs, file=file.path(model_path, "log_model_learning_paths_control_rs_last5.rds"))
log_model_learning_paths_control_rs <- readRDS(file.path(model_path, "log_model_learning_paths_control_rs_last5.rds"))
