...
function prepareTask(variationSelection) { // prepare list of what we should show
...
function prepareComponentFlow(variationSelection) { // prepare list of what we should show
    ...
    const variation = Variations.find(variation => variation.hasOwnProperty(variationSelection))
