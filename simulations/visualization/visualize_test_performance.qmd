...
```{r}
full_sr_beta01 <- read.csv(file.path(data_path, "random_sr_from_mb_wtoR_wfeat_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.1_gamma0.9.csv"))
full_sr_beta05 <- read.csv(file.path(data_path, "random_sr_from_mb_wtoR_wfeat_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.5_gamma0.9.csv"))
full_sr_beta09 <- read.csv(file.path(data_path, "random_sr_from_mb_wtoR_wfeat_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.9_gamma0.9.csv"))
```
...
```{r}
mb_1 <- read.csv(file.path(data_path, "model_based_learnt_nsimulations110_alpha_td0.9_alpha_m0.1_beta0.9_gamma0.9.csv"))
mb_2 <- read.csv(file.path(data_path, "model_based_learnt_nsimulations110_alpha_td0.9_alpha_m0.5_beta0.9_gamma0.9.csv"))
mb_3 <- read.csv(file.path(data_path, "model_based_learnt_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.9_gamma0.9.csv"))
```
