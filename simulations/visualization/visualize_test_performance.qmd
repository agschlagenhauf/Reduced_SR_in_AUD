...
full_sr_beta01 <- read.csv(file.path(data_path, "full_sr_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.1_gamma_td0.5_gamma_m0.5.csv"))
full_sr_beta05 <- read.csv(file.path(data_path, "full_sr_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.5_gamma_td0.5_gamma_m0.5.csv"))
full_sr_beta09 <- read.csv(file.path(data_path, "full_sr_nsimulations110_alpha_td0.9_alpha_m0.9_beta0.9_gamma_td0.5_gamma_m0.5.csv"))
...
# Plot value development

```{r}
successful <- full_sr_beta05_test %>%
  filter(condition == "Policy revaluation",
         action == 1)

non_successful <- full_sr_beta05_test %>%
  filter(condition == "Policy revaluation",
         action == 2)

examine_successful <- full_sr_beta05 %>%
...
examine_non_successful <- full_sr_beta05 %>%
  filter(condition == "policy",
