...
```{r}
full_sr_beta01 <- read.csv(file.path(data_path, "full_sr_forced_learning_nsimulations110_alpha_td0.95_alpha_m0.95_beta0.1_gamma0.9.csv"))
full_sr_beta05 <- read.csv(file.path(data_path, "full_sr_forced_learning_nsimulations110_alpha_td0.95_alpha_m0.95_beta0.5_gamma0.9.csv"))
full_sr_beta09 <- read.csv(file.path(data_path, "full_sr_forced_learning_nsimulations110_alpha_td0.95_alpha_m0.95_beta0.9_gamma0.9.csv"))
```
