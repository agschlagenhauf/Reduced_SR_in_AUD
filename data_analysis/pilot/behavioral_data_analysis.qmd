...
-   **start all trials from state 1** (allow SR to learn), except several distractor trials from states 2 & 3 (to mask beginning of re-learning phase)
...
-   let **all re-learning trials across conditions start in states 2, 3** with most of them **forced choice** --\> conditions more comparable, allows to derive re-learning measure
...
-   let **all re-learning trials start from states 2 and 3**, optimally with equal experience of changes across conditions

-   after test: ask participants to **rate how much better chosen vs unchosen option was** / how sure they are that their last choice led to the highest possible reward

    -   dimensional score for preference switch

    -   useful to relate to psychiatric symptom dimensions

## Summary: Revised task design {.smaller}

-   **facilitate learning**: floorplan in instructions, adding saptial component

-   start **all learning trials from state 1** (allow SR to learn), except several distractor trials from states 2 & 3 (to mask beginning of re-learning phase)
...
-   after test: **rating chosen vs unchosen option** --\> dimensional score for preference switch, useful to relate to psychiatric symptom dimensions
