...
model3 <- glmer(correct_path ~ condition*version*audit_sum + (1 | ID), data = logreg_test_path_condition_df_full, family = "binomial", glmerControl(optCtrl=list(maxfun=1e5), optimizer = "bobyqa"))
