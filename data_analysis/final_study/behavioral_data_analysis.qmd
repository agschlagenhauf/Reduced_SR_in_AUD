...
model3 <- glmer(correct_path ~ condition*version*audit_group + (1 | ID), data = logreg_test_path_condition_df_full, family = "binomial")
...
model4 <- glmer(correct_path ~ condition*audit_group + (1 | ID), data = logreg_test_path_condition_df_alcohol, family = "binomial")
...
model5 <- glmer(correct_path ~ condition*version*audit_group + (1 | ID), data = logreg_test_path_condition_df_full, family = "binomial")
